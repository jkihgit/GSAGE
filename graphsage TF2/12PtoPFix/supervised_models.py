...
class SupervisedGraphsage(models.SampleAndAggregate):
    ...
    def __init__(self, num_classes,
        ...
        if features is None: 
            ...
            # self.features = tf.Variable(features, trainable=False, dtype=tf.float32, synchronization=tf.VariableSynchronization.ON_READ, aggregation=tf.VariableAggregation.NONE)
    ...
    def minimini(self):
        ...
        history = self.train_model.fit(x=x, y=y, epochs=1, batch_size=batch_size, callbacks=callbacks)
