...
class UniformNeighborSampler(Layer):
    ...
    def __init__(self, adj_info, **kwargs):
        ...
        # self.adj_info = tf.Variable(adj_info, trainable=False, name='adjtab', dtype=tf.int32)
    ...
    def randomfix(self, inputs):
        ...
        with tf.compat.v1.colocate_with(self.adj_info):
            layer = tf.get_static_value(layer)
            ...
            randpicks = tf.concat([template, tf.cast(randpicks, dtype=tf.float32)], axis=2)
