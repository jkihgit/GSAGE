...
class SupervisedGraphsage(models.SampleAndAggregate):
    ...
    def train(self, verbose=2):
        ...
        with graph.as_default():
            ...
            history = self.train_model.fit(self.minibatch.entire_training_set(), validation_data=vds, validation_freq=validation_freq, callbacks=callbacks, epochs=FLAGS.epochs, verbose=verbose, shuffle=True)
