...
class SampleAndAggregate(GeneralizedModel):
    ...
    def sample(self, inputs, layer_infos, sampler, batch_size):
        ...
        for k in range(len(layer_infos)):
            ...
            samples.append(node((samples[k], layer_infos[t].num_samples, t)))
            support_sizes.append(support_size)
        return samples, support_sizes


    def aggregate(self, samples, input_features, dims, num_samples, support_sizes, batch_size,
